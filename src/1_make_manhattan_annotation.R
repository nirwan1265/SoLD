...
files <- files[1]
# Remaining lipids
base_dir_LMM <- "/Users/nirwantandukar/Documents/Research/results/GWAS/SAP/remaining/lowinput/raw_gwas"
files_remain <- list.files(path=base_dir_LMM, pattern = "\\.txt$", full.names = TRUE)
files_remain <- files_remain[1]

# Combine the two lists
file_all <- c(files, files_remain)
